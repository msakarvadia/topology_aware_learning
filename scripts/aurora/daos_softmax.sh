...
python ${EXPERIMENT_DIR}/src/experiments/softmax.py --rounds 25 --checkpoint_every 1 --parsl_executor aurora_local
#python ${EXPERIMENT_DIR}/src/experiments/cifar10.py --rounds 40 --checkpoint_every 1 --parsl_executor aurora_local
