                        ...
                        for agg_strategy in [
                            ...
                            if agg_strategy == "unweighted_fl":
                                if node != placement[0]:
                                    continue
                            num_exp += 1
                            stats_path = f"{args.rootdir}/data_topo_{topo_name}txt_{data}_64_{epoch}_{lr}_False_True_{label_alpha}_1000_10_{seed}_{agg_strategy}_0_None_{ood_type}_01_{node}__False_True_0_degree_True_True_5_{momentum}_{softmax_coeff}_{optimizer}_{wd}_09_098_{scheduler}_095_{T_0}_1_{eta_min}_100_1000_{num_example}_16381_20_150_1_{task_type}_evens_{R}_{matrix_type}_001/"
